...
export class NewOfferService {
  ...
  private isNewBoundingBoxDifferent(
    oldBox: any,
    newBox: any,
  ...
  setOffersBySearchRadius(
    ...
    return this.getOffers(lonMin, latMin, lonMax, latMax).pipe(
      debounceTime(300),
  ...
  getLevelsOfProcessing(): Observable<any> {
    return this.http.get<any>(
      `${environment.NEARBUY_API}/levels_of_processing`,
    );
  }
