    ...
    return this.storeService.selectedCompanyContext$.pipe(
      switchMap((company) => {
        ...
        return this.http.post<any>(
          `${environment.API_CORE}/new-menu-plans`,
          menuPlan,
        );
      }),
      catchError((error) => {
    ...
    return this.storeService.selectedCompanyContext$.pipe(
      switchMap((company) => {
        ...
        return this.http.delete<void>(
          `${environment.API_CORE}/new-menu-plans/${menuPlanId}`,
          { params },
        );
      }),
      catchError((error) => {
    ...
    return this.storeService.selectedCompanyContext$.pipe(
      switchMap((company) => {
        ...
        return this.http.delete<any>(
          `${environment.API_CORE}/new-menu-plans/${menuPlanId}/events/${eventId}`,
          { params },
        );
      }),
      catchError((error) => {
  ...
  getAllMenuPlans(): Observable<any[]> {
    return this.storeService.selectedCompanyContext$.pipe(
      switchMap((company) => {
        ...
        let params = new HttpParams().set('companyId', company.id);
        return this.http.get<any[]>(`${environment.API_CORE}/new-menu-plans`, {
          params,
        });
      }),
      catchError((error) => {
